...
Route::middleware(['auth', 'isAluno'])->prefix('aluno')->name('aluno.')->group(function () {
    ...
    Route::get('/documentos/create', [DocumentoAlunoController::class, 'create'])->name('documentos.create');
    Route::post('/documentos', [DocumentoAlunoController::class, 'store'])->name('documentos.store');
